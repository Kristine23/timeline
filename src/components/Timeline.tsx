            ...
            {timelineData.map((item, index) => {
              ...
              return (
                <div key={index} className="relative flex items-center">
                  ...
                  <div className={`absolute top-1/2 w-4 h-0.5 bg-border transform -translate-y-1/2 z-10 hidden md:block ${
                    isLeft 
                      ? 'right-1/2 mr-2' 
                      : 'left-1/2 ml-2'
                  }`}></div>
                  ...
                  {/* Content container */}
                  <div className={`w-full md:w-2/5 ${isLeft ? 'md:pr-6' : 'md:pl-6 md:ml-auto'}`}>
